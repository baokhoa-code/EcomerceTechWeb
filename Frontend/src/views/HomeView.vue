<template>
    <div>
        ...
        <div class="row row-cols-1 row-cols-md-4 g-4">
            ...
            <div class="col">
                <div class="card">
                    <img src="../assets/impact-carré.jpg" class="card-img-top" alt="..." />
                </div>
            </div>
            <div class="col">
                <div class="card">
                    <img src="../assets/invader-carre.jpg" class="card-img-top" alt="..." />
                </div>
            </div>
            <div class="col">
                <div class="card">
                    <img src="../assets/zeus-x-carré.jpg" class="card-img-top" alt="..." />
                </div>
            </div>
            <div class="col">
                <div class="card">
