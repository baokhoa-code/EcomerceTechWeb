    ...
    methods: {
        ...
        async getProducts() {
            try {
                ...
                this.loading = false;
                const temparray = productsList.map((item) => { return {quantity: 1,totalPrice: item.price, ...item};});
        ...
        getData(name, brand, price, description, image, id) {
